export const L2PoolContract = {
    ...
    "content": {
        "name": "AaveV3 L2 Pool",
        "description": "The AaveV3 L2 Pool contract is the main contract for interacting with the AaveV3 protocol on L2 chains. This contract facilitates all lending management including supplying, borrowing, repaying, withdrawing, and more.",
